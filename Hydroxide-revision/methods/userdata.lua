...
local function userdataValue(data)
    ...
    elseif dataType == "TweenInfo" or dataType == "Vector3" or dataType == "Vector2" or 
           dataType == "CFrame" or dataType == "Color3" or dataType == "Random" or 
           dataType == "Faces" or dataType == "UDim2" or dataType == "UDim" or 
           dataType == "Rect" or dataType == "Axes" or dataType == "NumberRange" or 
           dataType == "RaycastParams" or dataType == "PhysicalProperties" then
        return dataType .. ".new(" .. tostring(data) .. ")"
...
local function isUserdata(type)
    return type == "BrickColor" or type == "TweenInfo" or type == "Instance" or 
           type == "DateTime" or type == "Vector3" or type == "Vector2" or 
           type == "Region3" or type == "CFrame" or type == "Color3" or 
           type == "Random" or type == "Faces" or type == "UDim2" or 
           type == "UDim" or type == "Rect" or type == "Axes" or 
           type == "Ray" or type == "RaycastParams" or type == "PathWaypoint" or 
           type == "PhysicalProperties" or type == "ColorSequence" or 
           type == "ColorSequenceKeypoint" or type == "NumberRange" or 
           type == "NumberSequence" or type == "NumberSequenceKeypoint"
end
